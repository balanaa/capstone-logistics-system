...
export async function logDocumentAction({
  ...
  let userName = 'Unknown User'
  try {
    console.log(`[logDocumentAction] Fetching user name from profiles table for user: ${userId}`)
    ...
    if (!profileError && profile?.full_name) {
      ...
      console.log(`[logDocumentAction] Found user name in profiles: ${userName}`)
    } else {
      console.warn(`[logDocumentAction] Could not fetch user name from profiles:`, profileError)
